...
{
    public static class R1a_ClassAsObject
    {
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByName(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassBySimpleName(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByMethodWithoutParams(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByMethodWithParams(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByField(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByInterface(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassBySuperclass(Type type)
        {
            if (type == null)
            {
                return -1;
        ...
        // @SetteRequiredStatementCoverage(100)
        public static int guessClassByAnnotation(Type type)
        {
            if (type == null)
            {
                return -1;
