...
/**
 *
 * A generic collection used by the code snippets, whose methods always checks the specified
 * indices. This collection holds exactly 3 elements of the specified type.
 *
 * @param <T>the
