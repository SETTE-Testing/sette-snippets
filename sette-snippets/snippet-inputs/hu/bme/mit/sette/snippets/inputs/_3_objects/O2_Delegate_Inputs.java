...
public final class O2_Delegate_Inputs {
    ...
    public static SnippetInputContainer guessResult() {
        ...
        inputs.addByExpectedAndParameters(NullPointerException.class,
                new SimpleObjectDelegate(null), 0, 0, 0);
        inputs.addByParameters(new SimpleObjectDelegate(new SimpleObject()), 8, 1, -1);
        inputs.addByParameters(new SimpleObjectDelegate(new SimpleObject()), 0, 0, 0);
