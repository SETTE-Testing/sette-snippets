...
public final class B6a_CheckedExceptions_Inputs {
    ...
    public static SnippetInputContainer always() {
        ...
        inputs.addByExpectedAndParameters(Exception.class);
    ...
    public static SnippetInputContainer conditionalAndLoop() {
        ...
        inputs.addByExpectedAndParameters(Exception.class, -1);
        inputs.addByExpectedAndParameters(Exception.class, 20);
    ...
    public static SnippetInputContainer call() {
        ...
        inputs.addByParameters(1, -1);
        inputs.addByParameters(-1, -1);
        inputs.addByExpectedAndParameters(Exception.class, 0, 0);
    ...
    public static SnippetInputContainer tryCatch() {
        ...
        inputs.addByParameters(1, -1);
        inputs.addByParameters(-1, -1);
        inputs.addByExpectedAndParameters(MyException.class, 0, 0);
    ...
    public static SnippetInputContainer tryCatchFinally() {
        ...
        inputs.addByExpectedAndParameters(MyException.class, 0, 0, 1); // absorb
        // exception
