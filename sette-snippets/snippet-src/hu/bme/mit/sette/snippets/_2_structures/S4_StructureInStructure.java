...
@SetteSnippetContainer(category = "S4", goal = "Check support for structures containing other structures", inputFactoryContainer = S4_StructureInStructure_Inputs.class)
