...
@SetteSnippetContainer(category = "B5", goal = "Check support for recursive function calls (with depth limit)", inputFactoryContainer = B5b_LimitedRecursive_Inputs.class)
