...
import hu.bme.mit.sette.snippets.inputs._1_basic.B4_arrays.B4_UnsafeArrays_Inputs;
 ...
 */
@SetteSnippetContainer(category = "B4", goal = "Check support for arrays using unsafe operations", inputFactoryContainer = B4_UnsafeArrays_Inputs.class)
