...
@SetteSnippetContainer(category = "O3", goal = "Check support for class inheritance",
...
public final class O3a_Inheritance {
    ...
    @SetteIncludeCoverage(classes = { SimpleObject.class, SimpleExtendedObject.class },
            methods = { "addAbs(int)", "subtractAbs(int)" })
