...
import hu.bme.mit.sette.snippets.inputs._6_others.Varargs_Inputs;

@SetteSnippetContainer(category = "Others", goal = "Check support for variable argument lists", inputFactoryContainer = Varargs_Inputs.class)
