...
@SetteSnippetContainer(category = "L2", goal = "Check support for strings", inputFactoryContainer = L2_Strings_Inputs.class)
public final class L2_Strings {
    ...
    public static int compareToIgnoreCase(String s) {
        if (s == null) {
            return -1;
        } else if (s.compareToIgnoreCase("abcdd") > 0
                && s.compareToIgnoreCase("abcdf") < 0) {
            return 1;
        } else if (s.compareToIgnoreCase("EfGhH") > 0
                && s.compareToIgnoreCase("eFgHj") < 0) {
            return 2;
        } else if (s.compareToIgnoreCase("bbb") > 0
                && s.compareToIgnoreCase("aaa") < 0) {
            // impossible branch
            throw new RuntimeException();
        } else {
            return 0;
