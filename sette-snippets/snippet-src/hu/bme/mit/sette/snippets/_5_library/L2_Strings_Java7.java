...
@SetteSnippetContainer(category = "L2", goal = "Check support for strings", inputFactoryContainer = L2_Strings_Java7_Inputs.class, requiredJavaVersion = JavaVersion.JAVA_7)
