...
@SetteSnippetContainer(category = "Others", goal = "Check support for 3rd party libraries",
        inputFactoryContainer = Others_ThirdParty_Inputs.class)
public final class Others_ThirdParty {
    private Others_ThirdParty() {
