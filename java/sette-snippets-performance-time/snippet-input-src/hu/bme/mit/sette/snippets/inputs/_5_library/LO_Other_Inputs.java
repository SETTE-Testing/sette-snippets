...
public final class LO_Other_Inputs {
    ...
    public static SnippetInputContainer inheritsAPIGuessOnePrimitive() {
        ...
        inputs.addByExpectedAndParameters(IllegalArgumentException.class, 20);
    ...
    public static SnippetInputContainer inheritsAPIGuessTwoPrimitives() {
        ...
        inputs.addByExpectedAndParameters(IllegalArgumentException.class, 20, 0);
        inputs.addByExpectedAndParameters(RuntimeException.class, 9, 9);
    ...
    public static SnippetInputContainer inheritsAPIGuessTwoObjects() {
        ...
        inputs.addByExpectedAndParameters(RuntimeException.class, new FingerNumber(9),
                new FingerNumber(9));
    ...
    public static SnippetInputContainer associatesAPIGuessValidDateFormat() {
        ...
        inputs.addByExpectedAndParameters(IllegalArgumentException.class, (Object) null);
