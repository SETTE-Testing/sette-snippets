...
import hu.bme.mit.sette.snippets.inputs._9_reflection.R1a_ClassAsObject_Inputs;

@SetteSnippetContainer(category = "R1", goal = "Check support for java.lang.Class usage",
        inputFactoryContainer = R1a_ClassAsObject_Inputs.class)
public final class R1a_ClassAsObject {
    private R1a_ClassAsObject() {
        throw new UnsupportedOperationException("Static class");
    }

    @SetteRequiredStatementCoverage(100)
    public static int guessClassByName(Class<?> cls) {
        if (cls == null) {
            return -1;
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassBySimpleName(Class<?> cls) {
        if (cls == null) {
            return -1;
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassByMethodWithoutParams(Class<?> cls) {
        if (cls == null) {
            return -1;
        }
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassByMethodWithParams(Class<?> cls) {
        if (cls == null) {
            return -1;
        }
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassByField(Class<?> cls) {
        if (cls == null) {
            return -1;
        }
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassByInterface(Class<?> cls) {
        if (cls == null) {
            return -1;
        }
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassBySuperclass(Class<?> cls) {
        if (cls == null) {
            return -1;
    ...
    @SetteRequiredStatementCoverage(100)
    public static int guessClassByAnnotation(Class<?> cls) {
        if (cls == null) {
            return -1;
        }
