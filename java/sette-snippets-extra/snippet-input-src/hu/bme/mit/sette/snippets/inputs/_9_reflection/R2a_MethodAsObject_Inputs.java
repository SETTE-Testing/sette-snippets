...
public final class R2a_MethodAsObject_Inputs {
    private R2a_MethodAsObject_Inputs() {
    ...
    public static SnippetInputContainer guessMethodByNameAndDeclaringClass()
        ...
        sic.addByParameters(MyClassParent.class.getMethod("value", int.class));
        sic.addByParameters(Object.class.getMethod("toString"));
        return sic;
    }
    ...
    public static SnippetInputContainer guessMethodByNameAndReturnType()
        ...
        SnippetInputContainer sic = new SnippetInputContainer(1);
        sic.addByParameters((Object) null);
        sic.addByParameters(MyClassChild.class.getMethod("value"));
        sic.addByParameters(Object.class.getMethod("toString"));
        return sic;
    }
