...
public final class R1b_ClassWithLoading_Inputs {
    private R1b_ClassWithLoading_Inputs() {
    ...
    public static SnippetInputContainer guessClassByName() {
        ...
        sic.addByParameters(String.class.getName());
        sic.addByParameters(int[].class.getName());
        sic.addByParameters(MyClassParent.class.getName());
        sic.addByParameters(Void.class.getName());
        return sic;
    }
    ...
    public static SnippetInputContainer guessClassByMethodWithoutParams() {
        SnippetInputContainer sic = new SnippetInputContainer(1);
        sic.addByParameters((Object) null);
        sic.addByParameters(MyClassChild.class.getName());
        sic.addByParameters(Void.class.getName());
        return sic;
    }
